 ...
 *
 * This Fragment displays a list with the news headlines for a particular news category. When an
 * item is selected, it notifies the configured listener that a headlines was selected.
 */
public class HeadlinesFragment extends ListFragment implements OnItemClickListener {
  ...
  @Override public void onStart() {
    ...
    // TODO below probably not necessary, we call it all over elsewhere.
//    loadCategory(0);
  }
   ...
   */
  public void loadCategory(NewsCategory cat) {
    mHeadlinesList.clear();
    for (int i = 0; i < cat.getArticleCount(); i++) {
